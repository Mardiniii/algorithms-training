...
public class Solution {
    ...
    public static String[] getPath(Map<String, String[]> graph, String startNode, String endNode) {
        if (!graph.containsKey(startNode)) throw new IllegalArgumentException("Start Node can't be null");
        if (!graph.containsKey(endNode)) throw new IllegalArgumentException("End Node can't be null");
        ...
        Map<String, String> toNodeFromNode = new HashMap<>();
        toNodeFromNode.put(startNode, null);

        while (!nodesToVisit.isEmpty()) {
            String currentNode = nodesToVisit.remove();

            if (currentNode.equals(endNode)) {
                return reconstructPath(toNodeFromNode, startNode, endNode);
            }
            ...
            for (String neighbor : graph.get(currentNode)) {
                if (!nodesAlreadySeen.contains(neighbor)) {
                    ...
                    toNodeFromNode.put(neighbor, currentNode);
                }
            }
        }
